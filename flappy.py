...
# Background-Images
bg_day_image = pygame.image.load("assets/background-day.png").convert_alpha()
bg_day_image = pygame.transform.scale(bg_day_image, (WIDTH, HEIGHT))
bg_night_image = pygame.image.load("assets/background-night.png").convert_alpha()
...
game_over_message = pygame.image.load("assets/message.png").convert_alpha()
game_over_message = pygame.transform.scale(game_over_message, (300, 400))

# Bird-Images
birds = []
birds.append(pygame.image.load("assets/bluebird-downflap.png").convert_alpha())
birds.append(pygame.image.load("assets/bluebird-midflap.png").convert_alpha())
birds.append(pygame.image.load("assets/bluebird-upflap.png").convert_alpha())
bird_index = 0
bird_movement = 0
...
# Pipes
pipes = []
pipe_green_img = pygame.image.load("assets/pipe-green.png")
pipe_red_img = pygame.image.load("assets/pipe-red.png")
